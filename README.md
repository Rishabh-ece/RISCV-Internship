...
![SOC module — SPI ports added](Task6/spi_master/screenshots/output_wire.png)
...
![riscv.v — SPI assign statements](Task6/spi_master/screenshots/assign_spi.png)
...
![VSDSquadronFM.pcf — full pin assignments](Task6/spi_master/screenshots/vsdsquadronFM.png)
...
![make build — synthesis and place-and-route output](Task6/spi_master/screenshots/build.png)

**Flash result:**

![sudo make flash — VERIFY OK, cdone: high](Task6/spi_master/screenshots/make_flash.png)
...
![VSDSquadron FPGA Mini — board running after flash](Task6/spi_master/screenshots/fpga_baord.jpeg)
...
<details>
<summary><b>Task-7:</b> SPI Master IP for VSDSquadron FM BasicRISCV</summary>
<br>


[Task7- SPI Master IP for VSDSquadron FM BasicRISCV Documentation](https://github.com/Rishabh-ece/RISCV-Internship/tree/main/Task7/ip/spi_master)
